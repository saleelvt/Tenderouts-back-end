...
const adminRoutes = (dependencies) => {
    const { loginAdmin, adminAddPackage, adminAddDayDetailedPackage, deletePackage, deleteDeatailedPackage, adminGetPackages, adminGetDayDetailedPackage, userGetDataByQuery } = (0, controllers_1.adminController)(dependencies);
